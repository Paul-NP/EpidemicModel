...
class FastStandard:
    @staticmethod
    def get_SIR_builder() -> FastModelBuilder:
        builder = FastModelBuilder().add_stages(S=99, I=1, R=0)
    ...
    @staticmethod
    def get_SEIR_builder() -> FastModelBuilder:
        builder = FastModelBuilder().add_stages(S=99, E=0, I=1, R=0)
        builder.add_factor('beta', 0.4, latex_repr=r'\beta').add_factor('gamma', 0.1, latex_repr=r'\gamma')
    ...
    @staticmethod
    def get_SIRD_builder() -> FastModelBuilder:
        builder = FastModelBuilder().add_stages(S=99, I=1, R=0, D=0)
        builder.add_factor('beta', 0.4, latex_repr=r'\beta').add_factor('gamma', 0.1, latex_repr=r'\gamma')
    ...
    @staticmethod
    def get_SIRS_builder() -> FastModelBuilder:
        builder = FastModelBuilder().add_stages(S=99, I=1, R=0)
    ...
    @staticmethod
    def get_SEIRDS_builder() -> FastModelBuilder:
        builder = FastModelBuilder().add_stages(S=99, E=0, I=1, R=0, D=0)
        builder.add_factor('beta', 0.5, latex_repr=r'\beta').add_factor('gamma', 0.2, latex_repr=r'\gamma')
        builder.add_factor('delta', 0.2, latex_repr=r'\delta').add_factor('no_delta', 0.8, latex_repr=r'(1-\delta)')
